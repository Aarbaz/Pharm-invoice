    ...
    <div class="col-sm-12">
      <div class="panel panel-default">
        <div class="panel-heading">
          <h4>
            <?php echo ucwords($username).', ';?><small><?php echo  date('d F, Y');?></small><span class="text-sm pull-right"><a href="<?php echo site_url('Challan/logout');?>">Log Out</a></span>
          </h4>
        </div>
        ...
        <div class="panel-body"> 
          <div class="challan-div">               
            ...
            <div class="form-group"><br />
              <div id="error_box" class="col-sm-8 col-sm-offset-2"></div>
            </div>
            ...
            <div class="form-group">                
              <table class="table table-bordered">
                ...
                <div class="form-group"><br />
                  <div id="error_box2" class="col-sm-8 col-sm-offset-2"></div>
                </div>
            <?php echo form_close();  ?>
      ...
      success:function(resp){
        if( resp.status == 'failed')
        {
          ...
          $.each(resp.result, function(name, item){
            ...
            $('#error_box').append('<p class="text-danger text-center">'+item+'</p>');      
          });                                          
        }
        else if(resp.status == 'passed')
        {          
          $('#error_box').empty();
          $('#error_box2').append('<h4 class="alert alert-success text-center">'+resp.result+'</h4>');          
          $('#challan_form')[0].reset();     
          $('#error_box2 h4').fadeOut(5000, function(){
